...
;; Force the module to be built in C++ rather than C. Necessary when Cakelisp doesn't know whether
;; you are dependent on C++, e.g. when including headers not generated by Cakelisp
(defmacro require-cpp ()
  (RequiresCppFeature
