...
CAKELISP_API int getArgument(const TokenArray& tokens, int startTokenIndex,
                             int desiredArgumentIndex, int endTokenIndex);
CAKELISP_API int getExpectedArgument(const char* message, const TokenArray& tokens,
...
CAKELISP_API int getNumArguments(const TokenArray& tokens, int startTokenIndex, int endTokenIndex);
// Like getNumArguments, includes invocation
CAKELISP_API bool ExpectNumArguments(const TokenArray& tokens, int startTokenIndex,
...
CAKELISP_API int getNextArgument(const TokenArray& tokens, int currentTokenIndex,
...
CAKELISP_API void PushBackTokenExpression(TokenArray& output, const Token* startToken);
...
CAKELISP_API void PushBackAllTokenExpressions(TokenArray& output, const Token* startToken,
                                              const Token* finalToken);

void addModifierToStringOutput(StringOutput& operation, StringOutputModifierFlags flag);

CAKELISP_API void addStringOutput(StringOutputArray& output, const DynamicString& symbol,
                                  StringOutputModifierFlags modifiers, const Token* startToken);
CAKELISP_API void addLangTokenOutput(StringOutputArray& output,
                                     StringOutputModifierFlags modifiers, const Token* startToken);
...
CAKELISP_API bool parseFunctionSignature(const TokenArray& tokens, int argsIndex,
