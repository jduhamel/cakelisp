                       ...
                       GeneratorOutput& output)
{
	...
	ProcessCommandOptions commandOptions[] = {
	    ...
	    {"build-time-compile-arguments", &environment.buildTimeBuildCommand,
	     SetProcessCommandArguments},
	    {"build-time-c-compiler", &environment.buildTimeBuildCommandC, SetProcessCommandFileToExec},
	    {"build-time-c-compile-arguments", &environment.buildTimeBuildCommandC,
	     SetProcessCommandArguments},
                               ...
                               GeneratorOutput& output)
{
	...
	const StringOptionList possibleDestinations[] = {
		...
		{"add-cpp-build-options", &context.module->additionalCppOnlyBuildOptions},
...
void importFundamentalGenerators(EvaluatorEnvironment& environment)
{
	...
	environment.generators["add-cpp-build-options"] = AddStringOptionsGenerator;
